...
Reference full template: `/Users/jonathan/dev/ttc-dreamer/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/jonathan/dev/ttc-dreamer/.claude/get-shit-done/templates/state.md`.
